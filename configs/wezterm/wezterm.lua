  ...
  return {
    {
      ...
      icon = "cod_layout",
      action = wezterm.action_callback(function(_, pane) pane:send_text("vde-layout dev --currentWindow\n") end),
    },
    {
      brief = "nzm: Dev (Cursor + Claude + Term split)",
      icon = "cod_layout",
      action = wezterm.action_callback(function(_, pane) pane:send_text("nzm-cursor-split dev\n") end),
    },
    {
      brief = "nzm: Workspace (nvim + Claude + Terminal)",
      icon = "cod_layout",
      action = wezterm.action_callback(
        function(_, pane) pane:send_text("cd ~/dotfiles && vde-layout ws --currentWindow\n") end
      ),
    },
    {
      brief = "nzm: Workspace (Cursor + Claude + Term split, ~/dotfiles)",
      icon = "cod_layout",
      action = wezterm.action_callback(function(_, pane) pane:send_text("nzm-cursor-split ws\n") end),
    },
  }
end)
